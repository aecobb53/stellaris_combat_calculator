...
markdown_text.append(f"| 10 | X | - | - | - | {pointer.sprawl} | {pointer.research} | {int(pointer.research / pointer.sprawl * 10_000) / 10_000} |")
...
markdown_text.append(f"| 25 | X | - | - | - | {pointer.sprawl} | {pointer.research} | {int(pointer.research / pointer.sprawl * 10_000) / 10_000} |")
...
markdown_text.append(f"| 4 | - | X | - | - | {pointer.sprawl} | {pointer.research} | {int(pointer.research / pointer.sprawl * 10_000) / 10_000} |")
...
# 132 research all housing districts but still not actually enough housing
markdown_text.append(f"| 8 | - | X | - | - | {pointer.sprawl} | {pointer.research} | {int(pointer.research / pointer.sprawl * 10_000) / 10_000} |")
...
markdown_text.append(f"| 4 | - | X | - | X | {pointer.sprawl} | {pointer.research} | {int(pointer.research / pointer.sprawl * 10_000) / 10_000} |")
